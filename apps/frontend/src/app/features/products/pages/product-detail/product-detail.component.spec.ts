...
describe('ProductDetailComponent', () => {
    ...
    beforeEach(async () => {
        const productSpy = jasmine.createSpyObj('ProductService', ['getProductById']) as jasmine.SpyObj<ProductService>;
        const reviewSpy = jasmine.createSpyObj('ReviewService', ['getReviewsByProduct']) as jasmine.SpyObj<ReviewService>;
        ...
        reviewSpy.getReviewsByProduct.and.returnValue(of({ data: [{ id: 'r1' }], total: 1, page: 1, limit: 10 } as any));
